    ...
    <div className="buildPage">
      <div className="images">
        <div className="scroller">
          {build.images.map((imageUrl, i) =>
            <div className="image" data-i={i} style={"--image-url: " + imageUrl}></div>
          )}
        ...
        <div className="selector">
          {build.images.map((imageUrl, i) =>
            <div className="image" onclick={() => {document.querySelector(`.scroller > .image[data-i="${i}"]`).scrollIntoView({ behavior: 'smooth', block: 'nearest', inline: 'center' })}} style={"--image-url: " + imageUrl}></div>
          )}
        </div>
      </div>
      ...
      <div className="buildInstructions">
        {build.youtubeTutorialLink != "undefined" ? 
