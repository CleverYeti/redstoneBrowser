...
const inputTags = [
  {name: "editors_picks", isAward: true},
  {name: "fastest_of_size", isAward: true},
  {name: "fastest", isAward: true},
  {name: "smallest", isAward: true},
...
const inputStats = [
  {name: "opening", type: "integer"},
  {name: "closing", type: "integer"},
  {name: "openingReset", type: "integer"},
  {name: "closingReset", type: "integer"},
  {name: "width", type: "integer"},
  {name: "depth", type: "integer"},
  {name: "height", type: "integer"},
  {name: "doorWidth", type: "integer"},
  {name: "doorHeight", type: "integer"},
]
